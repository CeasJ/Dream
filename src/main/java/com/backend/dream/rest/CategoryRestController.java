...
//    public Category createCategory(@RequestBody JsonNode cate, Model model) throws Exception{
//        String namecategory = cate.get("name").asText();
//        return categoryService.checknameExists(namecategory) ? null : categoryService.createCategory(cate);
//    }
    @PostMapping()
