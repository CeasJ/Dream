...
public class LoginController {
    ...
    public String loginProcess(Model model, @RequestParam("username") String username, @RequestParam("password") String password){
        ...
        if (account.isPresent() && passwordEncoder.matches(password,account.get().getPassword()) && username.equalsIgnoreCase(account.get().getUsername())) return "redirect:/login/success";
